...
class ContentAuthControllerWebMvcTest {
    ...
    class RegisterByMobile {
        ...
        void validRequest_returnsUserId() throws Exception {
            ...
            mockMvc.perform(post("/content/auth/register/mobile")
    ...
    class LoginByPassword {
        ...
        void validRequest_returnsLoginResult() throws Exception {
            ...
            mockMvc.perform(post("/content/auth/login/password")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("""
    ...
    class LoginBySms {
        ...
        void validRequest_returnsLoginResult() throws Exception {
            ...
            mockMvc.perform(post("/content/auth/login/sms")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("""
    ...
    class RebindUnbind {
        ...
        void rebindMobile_valid_returnsSuccess() throws Exception {
            mockMvc.perform(post("/content/auth/rebind/mobile")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("""
        ...
        void unbindEmail_valid_returnsSuccess() throws Exception {
            mockMvc.perform(post("/content/auth/unbind/email")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("""
        ...
        void unbindThirdParty_valid_returnsSuccess() throws Exception {
            mockMvc.perform(post("/content/auth/unbind/third-party")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("""
    ...
    class PasswordReset {
        ...
        void resetByMobile_valid_returnsSuccess() throws Exception {
            mockMvc.perform(post("/content/auth/reset-password/mobile")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("""
        ...
        void resetByEmail_valid_returnsSuccess() throws Exception {
            mockMvc.perform(post("/content/auth/reset-password/email")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content("""
