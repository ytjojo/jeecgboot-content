-- 回滚 V3.9.1_54__content_social_subscription_foundation
...
-- 删除 content_user_notification_setting 新增列
...
-- 删除 content_user_subscription 新增列和索引
...
-- 删除 content_user_relation_group 新增列、索引和约束
...
-- 删除 content_user_relation 新增列和索引
