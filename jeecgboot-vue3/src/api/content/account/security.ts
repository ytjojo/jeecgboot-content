...
enum Api {
  status = '/api/v1/account-security/status',
  bindPhone = '/api/v1/account-security/bind/phone',
  rebindPhone = '/api/v1/account-security/rebind/phone',
  unbindPhone = '/api/v1/account-security/unbind/phone',
  bindEmail = '/api/v1/account-security/bind/email',
  rebindEmail = '/api/v1/account-security/rebind/email',
  unbindEmail = '/api/v1/account-security/unbind/email',
  bindThirdParty = '/api/v1/account-security/bind/third-party',
  unbindThirdParty = '/api/v1/account-security/unbind/third-party',
  devices = '/api/v1/account-security/devices',
  deviceRevoke = '/api/v1/account-security/devices/revoke',
  deviceTrust = '/api/v1/account-security/devices/trust',
  deviceUntrust = '/api/v1/account-security/devices/untrust',
  resetPassword = '/api/v1/account-security/password/reset',
  changePassword = '/api/v1/account-security/password/change',
  anomalyList = '/api/v1/account-security/anomaly/list',
  anomalyConfirm = '/api/v1/account-security/anomaly/confirm',
  anomalyDeny = '/api/v1/account-security/anomaly/deny',
  sendSecurityCode = '/api/v1/account-security/send-code',
}
