...
enum Api {
  mutualStatus = '/api/v1/content/user/relation/mutual-status',
  mutualFollowList = '/api/v1/content/user/relation/mutual-follow-list',
  ...
  specialFollowCancel = '/api/v1/content/user/relation/special-follow/cancel',
  groups = '/api/v1/content/user/relation/groups',
  groupCreate = '/api/v1/content/user/relation/group/create',
  groupRename = '/api/v1/content/user/relation/group/rename',
  groupDelete = '/api/v1/content/user/relation/group/delete',
  groupMove = '/api/v1/content/user/relation/group/move',
  groupRemove = '/api/v1/content/user/relation/group/remove',
  followList = '/api/v1/content/user/relation/follow-list',
  specialFollowList = '/api/v1/content/user/relation/special-follow-list',
  recommendations = '/api/v1/content/user/relation/recommendations',
  batchUnfollow = '/api/v1/content/user/relation/batch/unfollow',
  batchSpecialFollowCancel = '/api/v1/content/user/relation/batch/special-follow/cancel',
  feed = '/api/v1/content/user/relation/feed',
}
