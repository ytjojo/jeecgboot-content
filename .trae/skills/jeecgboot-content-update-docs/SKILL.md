---
name: jeecgboot-content-update-docs
description: This skill should be used when the user asks to "update documentation for my changes", "check docs for this PR", "what docs need updating", "sync docs with code", "scaffold docs for this feature", "document this feature", "review docs completeness", "add docs for this change", "what documentation is affected", "docs impact", or mentions "docs/", "docs/01-app", "docs/02-pages", "MDX", "documentation update", "API reference", ".mdx files". Provides guided workflow for updating Next.js documentation based on code changes.
---

# jeecgboot-content Documentation Updater
jeecgboot-content path
/jeecg-boot/jeecg-boot-module/jeecg-module-content
Guides you through updating  documentation based on code changes on the active branch. Designed for maintainers reviewing PRs for documentation completeness.
...
| -------------------------------------- | --------------------------- |
| `/jeecg-boot/jeecg-boot-module/jeecg-module-content` | Backend API reference     |
| `/jeecgboot-vue3/src`            | Frontend API reference      |
...
- `/jeecgboot-vue3/src/client/components/image.tsx` → `docs/01-app/03-api-reference/02-components/image.mdx`
- `/jeecgboot-vue3/src/server/config-shared.ts` → `docs/01-app/03-api-reference/05-config/`
