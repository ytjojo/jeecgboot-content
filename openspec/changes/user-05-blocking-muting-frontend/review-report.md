...
**FLAG-2**: spec.md API 路径已统一为 `/api/v1/content/user/relation/block` 格式，API 对齐表与 Requirement scenario 一致。

**FLAG-3**: design.md 与 PRD 在 API 设计上存在差异：
- PRD 使用 `DELETE /api/v1/content/user/relation/block/{targetUserId}`（Path Variable）
- design.md 使用 `POST /api/v1/content/user/relation/unblock`（@RequestParam）
...
|---|---------|----------------|-------------|------|
| 1 | POST /api/v1/content/user/relation/block | ✅ | ✅ | 一致 |
| 2 | POST /api/v1/content/user/relation/unblock | ✅ | ✅ | 一致 |
| 3 | GET /api/v1/content/user/relation/blacklist | ✅ | ✅ | 一致 |
| 4 | GET /api/v1/content/user/relation/detail | ✅ | ✅ | 一致 |
| 5 | GET /api/v1/content/user/relation/block-mute/help | ✅ | ✅ | 一致 |
| 6 | POST /api/v1/content/user/relation/mute | ✅ | ✅ | 一致 |
| 7 | POST /api/v1/content/user/relation/mute/cancel | ✅ | ✅ | 一致 |
| 8 | GET /api/v1/content/user/relation/mute-list | ✅ | ✅ | 一致 |
| 9 | POST /api/v1/content/user/filter-rule | ✅ | ✅ | 一致 |
| 10 | POST /api/v1/content/user/filter-rule/delete | ✅ | ✅ | 一致 |
| 11 | POST /api/v1/content/user/filter-rule/batch-delete | ✅ | ✅ | 一致 |
| 12 | GET /api/v1/content/user/filter-rule/list | ✅ | ✅ | 一致 |
| 13 | POST /api/v1/content/user/not-interested | ✅ | ✅ | 一致 |
...
**FLAG-6**: spec.md API 路径已统一，Requirement scenario 与 API 对齐表和 tasks.md 一致。
...
| FLAG-2 | 一致性 | spec.md Requirement 部分引用旧 API 路径 | 统一为 `/api/v1/content/user/relation/block` 等实际后端路径 | ✅ 已验证无旧路径 |
