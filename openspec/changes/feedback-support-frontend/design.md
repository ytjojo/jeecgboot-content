...
| Q2 | 帮助文章数据来源？ | 帮助中心 API | 假设由运营通过 CMS 后台管理 |
| Q3 | 智能客服 NLP 引擎是否已就绪？ | 智能客服对话 | 假设使用现有引擎 |
| Q4 | 举报/申诉的通知方式？ | 通知对接 | 假设使用现有站内通知系统 |
| Q5 | 文件上传是否支持断点续传？ | 证据上传 | 假设不支持 |
| Q6 | 客服优先级阈值：LV.15+ 还是 LV.5+？ | 排队逻辑 | 按 PRD 假设 LV.15+ |
| Q7 | 举报/申诉撤回 API 是否已就绪？ | 撤回功能 | 假设后端支持 |
