...
| 功能 | 方法 | 路径 | 参数 |
|------|------|------|------|
| 圈子等级信息 | GET | `/api/v1/content/user/growth/level/info` | circleId |
| 成员成长信息 | GET | `/api/v1/content/user/growth/info` | circleId, userId |
| 连续参与天数 | GET | `/api/v1/content/user/growth/participation` | circleId, userId |
| 成就徽章列表 | GET | `/api/v1/content/user/growth/achievement/list` | circleId, userId |
| 圈子排行榜 | GET | `/api/v1/content/user/growth/leaderboard` | circleId, dimension(EXP/CONTRIBUTION/POST), period(WEEK/MONTH/ALL,默认WEEK), currentUserId |
