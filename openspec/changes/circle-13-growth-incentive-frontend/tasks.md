...
- [ ] 9.1 流程确认 — 所有任务使用 subagent + TDD 流程完成
- [ ] 9.2 Code Review — 按 git SHA 范围派发 reviewer subagent，检查代码质量、命名、边界条件、安全性
- [ ] 9.3 覆盖率 ≥ 90% — 不满足则补充测试
- [ ] 9.4 模块全量测试 100% 通过 — 禁止带红提交
- [ ] 9.5 合并 + 验证 + 清理 worktree — 按 AGENTS.md 标准流程完成
