...
- 新增成长相关 API 封装：圈子等级(`GET /api/v1/content/circle/growth/level/info`)、成员成长(`GET /api/v1/content/user/growth/info`)、成就徽章列表(`GET /api/v1/content/user/growth/achievement/list`)、排行榜(`GET /api/v1/content/user/growth/leaderboard`)四个核心接口
...
- **API 依赖**: 依赖后端 4 个已有接口（`/api/v1/content/circle/growth/level/info`、`/api/v1/content/user/growth/info`、`/api/v1/content/user/growth/achievement/list`、`/api/v1/content/user/growth/leaderboard`）
