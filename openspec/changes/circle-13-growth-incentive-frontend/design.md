...
- 成员成长: `GET /api/v1/content/circle/growth/info?circleId=&userId=` (MemberGrowthController)
...
- 连续参与: `GET /api/v1/content/circle/growth/participation?circleId=&userId=` (MemberGrowthController)
...
| `recentBadges` | 单独调用 `GET /api/v1/content/circle/growth/achievement/list` 获取 |
...
| `levelName` | `levelName` | 等级名称 |
| `nextLevelExp` | `nextLevelExp` | 下一等级所需经验值 |
